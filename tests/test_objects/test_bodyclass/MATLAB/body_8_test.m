...
% mkdir body_8_test
% save body_8_test/body1_linearHydroRestCoef.mat  body1_linearHydroRestCoef
% save body_8_test/body1_visDrag.mat  body1_visDrag 
% save body_8_test/body1_linearDamping.mat body1_linearDamping
% save body_8_test/body1_userDefinedFe.mat  body1_userDefinedFe 
% save body_8_test/body1_re.mat  body1_re
% save body_8_test/body1_im.mat  body1_im 
% save body_8_test/body1_md.mat  body1_md
% save body_8_test/body1_fAddedMass.mat body1_fAddedMass
% save body_8_test/body1_fDamping.mat  body1_fDamping
% save body_8_test/body1_irkb.mat body1_irkb
% save body_8_test/body1_A.mat body1_A
% save body_8_test/body1_B.mat body1_B
% save body_8_test/body1_C.mat body1_C
% save body_8_test/body1_D.mat body1_D
% % save body_8_test/body1_totDOF.mat  body1_totDOF
% 
% save body_8_test/body2_linearHydroRestCoef.mat  body2_linearHydroRestCoef
% save body_8_test/body2_visDrag.mat  body2_visDrag 
% save body_8_test/body2_linearDamping.mat body2_linearDamping
% save body_8_test/body2_userDefinedFe.mat  body2_userDefinedFe 
% save body_8_test/body2_re.mat  body2_re
% save body_8_test/body2_im.mat  body2_im 
% save body_8_test/body2_md.mat  body2_md 
% save body_8_test/body2_fAddedMass.mat body2_fAddedMass
% save body_8_test/body2_fDamping.mat  body2_fDamping
% save body_8_test/body2_irkb.mat body2_irkb
% save body_8_test/body2_A.mat body2_A
% save body_8_test/body2_B.mat body2_B
% save body_8_test/body2_C.mat body2_C
% save body_8_test/body2_D.mat body2_D
% % save body_8_test/body2_totDOF.mat  body2_totDOF
% 
% save body_8_test/CTTime.mat CTTime
% save body_8_test/w.mat w
% save body_8_test/waveAmpTime.mat waveAmpTime
