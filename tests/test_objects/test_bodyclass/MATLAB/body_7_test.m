...
% mkdir body_7_test
% save body_7_test/body1_linearHydroRestCoef.mat  body1_linearHydroRestCoef
% save body_7_test/body1_visDrag.mat  body1_visDrag 
% save body_7_test/body1_linearDamping.mat body1_linearDamping
% save body_7_test/body1_userDefinedFe.mat  body1_userDefinedFe 
% save body_7_test/body1_re.mat  body1_re
% save body_7_test/body1_im.mat  body1_im 
% save body_7_test/body1_md.mat  body1_md
% save body_7_test/body1_fAddedMass.mat body1_fAddedMass
% save body_7_test/body1_fDamping.mat  body1_fDamping
% save body_7_test/body1_irkb.mat body1_irkb
% % save body_7_test/body1_totDOF.mat  body1_totDOF
% 
% save body_7_test/body2_linearHydroRestCoef.mat  body2_linearHydroRestCoef
% save body_7_test/body2_visDrag.mat  body2_visDrag 
% save body_7_test/body2_linearDamping.mat body2_linearDamping
% save body_7_test/body2_userDefinedFe.mat  body2_userDefinedFe 
% save body_7_test/body2_re.mat  body2_re
% save body_7_test/body2_im.mat  body2_im 
% save body_7_test/body2_md.mat  body2_md 
% save body_7_test/body2_fAddedMass.mat body2_fAddedMass
% save body_7_test/body2_fDamping.mat  body2_fDamping
% save body_7_test/body2_irkb.mat body2_irkb
% % save body_7_test/body2_totDOF.mat  body2_totDOF
% 
% save body_7_test/CTTime.mat CTTime
% save body_7_test/w.mat w
% save body_7_test/waveAmpTime.mat waveAmpTime
