...
acc =[80 33 90 62 34 89;72 14 56 93 22 19]
fam = body(1).forceAddedMass(acc,simu.b2b)
...
%save body_4_test/body1_fAddedMass_adjusted.mat body1_fAddedMass_adjusted
% save body_4_test/body1_fam.mat fam
